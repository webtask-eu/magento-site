...
class Interceptor extends \Magento\Sales\Model\Order\Status implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'assignState');
        return $pluginInfo ? $this->___callPlugins('assignState', func_get_args(), $pluginInfo) : parent::assignState($state, $isDefault, $visibleOnFront);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'unassignState');
        return $pluginInfo ? $this->___callPlugins('unassignState', func_get_args(), $pluginInfo) : parent::unassignState($state);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadDefaultByState');
        return $pluginInfo ? $this->___callPlugins('loadDefaultByState', func_get_args(), $pluginInfo) : parent::loadDefaultByState($state);
    }
