...
class Interceptor extends \Magento\Catalog\Pricing\Render\PriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function jsonEncode($valueToEncode)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('jsonEncode', func_get_args(), $pluginInfo) : parent::jsonEncode($valueToEncode);
    }
    ...
    public function getCanDisplayQty(\Magento\Catalog\Model\Product $product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCanDisplayQty', func_get_args(), $pluginInfo) : parent::getCanDisplayQty($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'formatPercent');
        return $pluginInfo ? $this->___callPlugins('formatPercent', func_get_args(), $pluginInfo) : parent::formatPercent($percent);
    }
