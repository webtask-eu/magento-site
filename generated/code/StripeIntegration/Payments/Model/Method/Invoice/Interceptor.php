...
class Interceptor extends \StripeIntegration\Payments\Model\Method\Invoice implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($eventManager, $valueHandlerPool, $paymentDataObjectFactory, $code, $formBlockType, $infoBlockType, $config, $helper, $convert, $invoiceItemFactory, $invoiceFactory, $orderInvoiceFactory, $cache, $commandPool, $validatorPool);
    }
