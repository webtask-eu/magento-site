...
class PostCategory extends \Magento\Framework\View\Element\Template
{
    /**
    ...
    /**
     * @return obj $category obj
     */
    public function getCurrentCategory()
    {
        return $this->getRequest()->getParam('category_object');
    }
    ...
    public function getPostCollection()
    {
        ...
        $collection->addFieldToFilter(
            'category',
            [
                ['finset' => $this->getCurrentCategory()->getCategoryIdentifier()]
            ]
        );
