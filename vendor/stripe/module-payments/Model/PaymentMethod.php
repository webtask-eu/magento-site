...
class PaymentMethod extends \Magento\Payment\Model\Method\Adapter
{
    ...
    public function order(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        $createParams = $this->setupIntentHelper->getCreateParams($this->helper->getQuote(), $payment->getOrder());
        ...
        if ($setupIntent->status == "requires_action")
        {
            ...
            return $this->helper->dieWithError("Authentication Required: " . $setupIntent->client_secret);
        }
        ...
        {
            return $this->helper->dieWithError("The payment method could not be saved. Please try again.");
        }
