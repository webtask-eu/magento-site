...
class Service implements ServiceInterface
{
    ...
    public function place_order($result, $location)
    {
        ...
        try {
            ...
            if (!empty($result['payerName']))
            {
                $payerName = $result['payerName'];
            }
            else if (!empty($paymentMethod['billing_details']['name']))
            {
                $payerName = $paymentMethod['billing_details']['name'];
            }
            else if (!empty($result['shippingAddress']['recipient']))
            {
                $payerName = $result['shippingAddress']['recipient'];
            }
            else
            {
                $payerName = null;
