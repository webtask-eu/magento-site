...
namespace Eltrino\SampleData\Console\Command;
...
use Magento\SampleData\Console\Command\SampleDataDeployCommand as OriginalSampleDataDeployCommand;
 ...
 */
class SampleDataDeployCommand extends OriginalSampleDataDeployCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!empty($sampleDataPackages)) {
            ...
            $commonArgs = ['--working-dir' => $baseDir, '--no-progress' => true];
