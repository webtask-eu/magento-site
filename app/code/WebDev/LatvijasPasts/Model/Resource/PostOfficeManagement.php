...
class PostOfficeManagement implements PostOfficeManagementInterface
{
    private Reader $reader;
    private FilesystemDriver $filesystemDriver;
    private const SOURCE_FILE_NAME = 'post_office.json';
    private const API_ENDPOINT = 'https://express.pasts.lv/postOfficeApi';
