...
class Smartwave_Porto_Model_System_Config_Source_Setting_Installation_Demoversion
{
    public function toOptionArray()
    {
        return array(
            ...
            array('value' => 'demo22', 'label' => Mage::helper('porto')->__('Demo 22')),
            array('value' => 'demo23', 'label' => Mage::helper('porto')->__('Demo 23')),
            array('value' => 'demo24', 'label' => Mage::helper('porto')->__('Demo 24')),
            array('value' => 'demo25', 'label' => Mage::helper('porto')->__('Demo 25')),
            array('value' => 'demo26', 'label' => Mage::helper('porto')->__('Demo 26')),
            array('value' => 'demo27', 'label' => Mage::helper('porto')->__('Demo 27')),
            array('value' => 'demo28', 'label' => Mage::helper('porto')->__('Demo 28')),
            array('value' => 'demo29', 'label' => Mage::helper('porto')->__('Demo 29')),
            array('value' => 'demo30', 'label' => Mage::helper('porto')->__('Demo 30'))
        );
    }
}